...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "mch";//数据库名字
    public static String TABLE_NAME= MyApplication.userOnLine.getUsername();// 表名
    public static String  FIELD_FRIEND= "friend";// 列名
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //创建表
        String sql = "CREATE TABLE IF NOT EXISTS " + MyApplication.userOnLine.getUsername() + "(id integer primary key auto_increment ,friend varchar(20),time varchar(50),messageType integer(10),messageContent varchar(400),type int(10));";
